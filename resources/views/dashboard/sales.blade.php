...
const ctx2 = document.getElementById('followUpHealthChart').getContext('2d');
new Chart(ctx2, {
    type: 'bar',
    data: {
        labels: ['Completed','Pending','Overdue'],
        datasets: [{ label: 'Follow-ups', data: [{{ $completedFollowUpsCount }},{{ $pendingFollowUps }},{{ $overdueFollowUpsCount }}], backgroundColor: ['#166534','#0891b2','#dc2626'] }]
    },
